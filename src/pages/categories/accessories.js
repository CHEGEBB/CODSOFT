...
const Accessories = () => {
  const [items, setItems] = useState([
    ...
    },
    {
      ...
      rating: 5,
      images: [
        require("../../images/webp/accessories/a5.avif"),
        require("../../images/webp/accessories/a6.jpg"),
        require("../../images/webp/accessories/a7.jpg"),
        require("../../images/webp/accessories/a8.jpg"),
      ],
      wishlistIconPath: wishlistIcon,
      addToCartIconPath: cartIcon,
      currentImageIndex: 0
